<div class="card">
    ...
    <div class="table-stats order-table ov-h">
                ...
                <?php foreach ($giamgias as $key => $giamgia) : ?>
                    ...
                    <tr class="text-center">
                        ...
                        <td class=""><?php if ($giamgia['trang_thai'] == 1) {
                                        ...
                                        ?></td>
                        <td>
                            <form action="/delete-giam-gia" method="post">
                                <div class="" style="display: grid;grid-template-columns: 1fr;gap: 2px;">
                                    <input type="text" name="id" value="<?= $giamgia['id'] ?>" readonly hidden>
                                    <input onclick="return confirm('Bạn có chắc muốn xóa mã giảm giá id: <?= $giamgia['id'] ?>');" class="btn btn-danger" type="submit" value="Xóa">
                                </div>
                            </form>
        ...
        <div class="text-left mx-3">
            <a class="btn btn-info text-light" role="button" href="/admin-giam-gia1">Mã giảm giá đã xóa</a>
        </div>
    </div>
</div>