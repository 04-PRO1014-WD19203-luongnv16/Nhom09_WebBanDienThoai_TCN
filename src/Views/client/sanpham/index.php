            ...
            <div class="container">
                <div>
                    <div class="search" style="width: 25%;margin-left: 75%;">
                        <!-- <form action="/cua-hang" method="post">
                            <div class="form-group" style="display: flex;">
                                <input class="form-control" type="text" name="kyw" placeholder="Bạn tìm gì...">
                                <input class="bg-primary btn-primary text-center" name="timkiem"
                                    style="border-color: #ffa45c;width: 100px;" type="submit" value="Tìm kiếm">
                            </div>
                        </form> -->
                    </div>
                </div>
                        ...
                        <div class="row">
                            <?php foreach ($sanphams as $sanpham): ?>
                                <div class="col-sm-3 col-md-3 col-lg-3 ftco-animate">
                                    <div class="product">
                                        <a href="/detail-san-pham?id=<?= $sanpham['id'] ?>" class="img-prod"><img
