                        ...
                        <div class="row align-items-end">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php if($checkForm['ten_nguoi_nhan']) :?>
                                        <p class="text-danger">Không thể bỏ trống tên người nhận</p>
                                    <?php endif?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php if($checkForm['dia_chi']) :?>
                                        <p class="text-danger">Không thể bỏ trống địa chỉ nhận hàng</p>
                                    <?php endif?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php if($checkForm['email']) :?>
                                        <p class="text-danger">Không thể bỏ Email</p>
                                    <?php endif?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php if($checkForm['so_dien_thoai']) :?>
                                        <p class="text-danger">Không thể bỏ trống số điện thoại</p>
                                    <?php endif?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 d-flex">
                                <div class="cart-detail cart-total bg-light p-3 p-md-4">
                                    ...
                                    <p class="d-flex">
                                        <span>Giảm giá</span>
                                        <span>
                                            <input readonly hidden class="d-none" name="id_ma_giam_gias" type="text" value="<?=$id_ma_giam_gias?>">
                                            <?=$giam_gia?>
                                            <input readonly hidden class="d-none" name="shortcode" type="text" value="<?=$_POST['shortcode']?>">
                                        </span>
                                    </p>
                                    <hr>
                                    <p class="d-flex total-price">
                                        <span>Thành tiền</span>
                                        <span><input class="border-0 w-100 border-bottom border-primary bg-light" type="text" value="<?= $_POST['tong_tien']-$giam_gia?>" name="tong_tien" readonly style="outline: none;background-color: ;"></span>
                                    </p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="cart-detail bg-light p-3 p-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php endforeach?>
                                        <?php if($checkForm['thanh_toan']) :?>
                                            <p class="text-danger">Vui lòng chọn phương thức thanh toán</p>
                                        <?php endif?>
                                    </div>
